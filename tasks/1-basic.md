...
### Вопросы:
 ...
 - С помощью какой команды можно посмотреть статистику потребелния памяти?
...
В данном разделе вы узнаете, что такое выражения, сопоставление с образцом, одиночные присваивания(связаывания).
